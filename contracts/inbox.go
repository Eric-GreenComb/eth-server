...
const InboxABI = "[{\"inputs\":[],\"name\":\"get\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"x\",\"type\":\"uint256\"}],\"name\":\"set\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]"
...
var InboxBin = ""
...
func (_Inbox *InboxCaller) Get(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Inbox.contract.Call(opts, &out, "get")
...
func (_Inbox *InboxSession) Get() (*big.Int, error) {
	return _Inbox.Contract.Get(&_Inbox.CallOpts)
}
...
func (_Inbox *InboxTransactor) Set(opts *bind.TransactOpts, x *big.Int) (*types.Transaction, error) {
	return _Inbox.contract.Transact(opts, "set", x)
}
...
func (_Inbox *InboxSession) Set(x *big.Int) (*types.Transaction, error) {
	return _Inbox.Contract.Set(&_Inbox.TransactOpts, x)
}
